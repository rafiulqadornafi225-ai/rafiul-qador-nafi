          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            {isAdmin && (
              <motion.div 
                ...
                className="inline-flex flex-col sm:flex-row items-center gap-2.5 bg-rose-500/10 border border-rose-500/35 px-5 py-2.5 rounded text-xs font-bold text-rose-400 mb-8 uppercase tracking-wider"
              >
